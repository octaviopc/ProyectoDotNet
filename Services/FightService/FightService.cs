    ...
    public class FightService: IFightService
    {
        ...
        public async Task<ServiceResponse<FightResultDto>> Fight(FightRequestDto request)
        {
            ...
            try
            {
                ...
                bool defeated = false;
                while(!defeated){
                    foreach(Characters attacker in characters)
                    {
        ...
        private static int DoSkillAtack(Characters? attacker, Characters? opponent, Skill? skill)
        {
        ...
        Task<ServiceResponse<FightRequestDto>> IFightService.Fight(FightRequestDto request)
        {
